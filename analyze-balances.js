...
console.log(`Accounts staking ATOM: ${accountsStaking} (${percentStaking}%)`);
console.log('');
...
console.log(`Stargaze accounts staking ATOM: ${stargazeAccountsStaking.size} (${((stargazeAccountsStaking.size / totalAccounts) * 100).toFixed(2)}% of all Stargaze accounts)`);
